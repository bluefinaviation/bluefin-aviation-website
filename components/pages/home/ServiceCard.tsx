    ...
    <Link href={slug} className={clsx('group relative h-screen', className)}>
      ...
      <div className="absolute bottom-5 left-5 z-10 sm:bottom-10 sm:left-10">
        ...
        <div className="flex items-center">
          ...
          <AiOutlineArrowRight className="tw-transition ml-1.5 h-7 w-7 text-slate-200 group-hover:ml-3 sm:ml-2 sm:h-10 sm:w-10 sm:group-hover:ml-4 lg:ml-3 lg:h-12 lg:w-12 lg:group-hover:ml-5" />
        </div>
      </div>
    </Link>
  );
