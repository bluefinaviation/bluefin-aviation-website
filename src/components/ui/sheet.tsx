...
const SheetHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 bg-primary px-4 pt-16 pb-8 text-center sm:text-left',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn('dark text-2xl font-semibold text-foreground', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn('dark text-base text-muted-foreground', className)}
    {...props}
  />
))
