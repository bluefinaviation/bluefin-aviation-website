...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col bg-primary space-y-2 px-8 pt-16 pb-8 text-center sm:text-left",
      className
    )}
    {...props}
  />
...
const SheetTitle = (
  ...
  ref={ref}
  className={cn("text-2xl dark font-semibold text-foreground", className)}
  {...props}
/>);
...
const SheetDescription = (
  ...
  ref={ref}
  className={cn("text-base dark text-muted-foreground", className)}
  {...props}
/>);
