    ...
    <div className='relative h-[calc(100vh-4rem)] sm:h-[calc(100vh-5rem)] lg:h-[calc(100vh-6rem)]'>
      <div aria-hidden='true' className='absolute inset-0 overflow-hidden'>
        <Image
          ...
          height={1080}
          priority
          className='hidden size-full object-cover object-center shadow lg:block'
        />
        <Image
          src={
            hero?.image?.asset?._ref
          ...
          height={1080}
          priority
          className='block size-full bg-slate-200 object-cover object-center shadow lg:hidden'
        />
